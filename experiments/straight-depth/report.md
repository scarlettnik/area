...
- objective: minimum official weighted score among feasible candidates
- geometry tie-break: fewer micro-bends, bends and right-angle turns within 1.0% score
- optional routing turn bias = 8.0 m
...
Ranked variants:
1. cost_cheapest: S=15.604616, cost=376,839,933.37 rub, length=1684.366 m, connected=16/17, bends=12, micro-bends=1, tie-ins=1, unconnected=['16']
2. cost_demand: S=21.026492, cost=587,847,682.56 rub, length=1522.252 m, connected=14/17, bends=11, micro-bends=0, tie-ins=1, unconnected=['4', '12', '16']

Best result:
- cost_cheapest ranked first because it has the lowest official score among the evaluated topologies; geometry breaks ties within the configured score tolerance.
- File: experiments/straight-depth/best_variant.geojson
...
- Search bias and official score are separate; monetary bend surcharge is zero by default.
- Near-score alternatives prefer fewer micro-bends, bends and right-angle turns.
...
- Depth and special crossings are checked with shared-node profiles and utility clearances.
